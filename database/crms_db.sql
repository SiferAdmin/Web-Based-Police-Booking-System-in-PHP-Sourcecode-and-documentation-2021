...
--
-- Table structure for table `deskofficer`
--
...
--
-- Dumping data for table `deskofficer`
--

INSERT INTO `deskofficer` (`id`, `name`, `address`, `contact`, `status`, `email`, `password`) VALUES
...
INSERT INTO `booking` (`id`,`title`, `complainant_id`, `message`, `address`,`typeofcrimecompalin`,`repotername`,`reportercontact`, `date_created`, `status`, `evidence`) VALUES
...
--
-- Table structure for table `bookingaction`
--
...
--
-- Dumping data for table `bookingaction`
--

INSERT INTO `bookingaction` (`id`, `complaint_id`, `responder_id`, `dispatched_by`, `status`, `remarks`, `date_created`) VALUES
...
--
-- Indexes for table `deskofficer`
--
ALTER TABLE `deskofficer`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `bookingaction`
--
ALTER TABLE `bookingaction`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `deskofficer`
--
ALTER TABLE `deskofficer`
...
--
-- AUTO_INCREMENT for table `bookingaction`
--
ALTER TABLE `bookingaction`
