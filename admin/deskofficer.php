			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Booked Crimes or Complaints</b>
					</div>
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$complainant = $conn->query("SELECT * FROM deskofficer  order by name asc ");
								...
								<tr>
									...
									<?php endif; ?>
										<button class="btn btn-sm btn-outline-primary view_complaints" type="button" data-id="<?php echo $row['id'] ?>"   data-name="<?php echo $row['name'] ?>">View Crime or Complaint</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
